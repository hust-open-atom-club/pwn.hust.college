...
同学们可以将 KOOK 个人账号连接到平台中，这样可以通过 pwn.hust.college 平台在 KOOK 频道中接收信息广播。

## 2.6 帮助

当前平台已移除 SensAI / Open WebUI 相关的大语言模型帮助入口。遇到挑战问题时，可以点击顶部导航栏中的“聊天”进入 KOOK 频道，与课程教师、助教和其他同学交流。
