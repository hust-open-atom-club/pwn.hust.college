...
![pwn.hust.college 平台架构示意图](static/TI7hbOlhDoNy8Jxgv6pcROaLn5e.png)
...
![pwn.hust.college 平台架构示意图](static/Z4a7bHIdXotSYzx97NRcFDBCnIb.png)
...
![添加道馆部署秘钥示意图](static/NESzbol3HoOzZ4xeUysc9uNTnbb.png)

1. 创建成功之后，即可看见下图所示。同时，在道馆列表中看到该道馆。

![道馆创建成功示意图](static/BkzWbyEcjo2XEdxbt8IciqWKnPh.png)

![Screenshot](static/WWIJbZTsRoPMPlxEaCycFdh0noc.png)

## 2.3 道馆更新

以管理员账号进入刚创建好的 Example 道馆，并点击进入管理员界面，

![Screenshot](static/IlNzbirx7oIlXnxwupFcQud8nah.png)

在管理员界面中，你可以通过“更新”按钮，使用最新的代码仓库。代码仓库可以通过代码提交的方式不断进行更新和迭代。

![Screenshot](static/F2sxb3c9BouF61xM1CIccquynWd.png)

![Screenshot](static/Bo3xbsbt1oUqpbxnD8ecWRmanKb.png)
...
![Screenshot](static/HHM1bqcaSokSk6xiA01cxffOnOc.png)
...
![Screenshot](static/Z73VbWoLSoaWTsxfop4cGdHOnpb.png)
...
![Screenshot](static/P4rtb0q00oux5TxrRc4cPF5Rnse.png)

接下来，我们进入平台和用户管理的界面，点击右上角的管理面板进入。

![Screenshot](static/F86Nb4Wf3o39ZjxD34rcQ2V1ncg.png)

进入到下列界面即代表我们进入 admin 的管理界面。

![Screenshot](static/OZzhbYiI9oLZ8MxM79lcioLnnqg.png)
...
![Screenshot](static/S6RBbYhr9oh1MkxOuTTcylUrnWd.png)

点击 user 图标进行修改用户的个人信息。

![Screenshot](static/EqIdbWULFoPy2ixQ2u9cie3ZnHd.png)

弹出一个表单，允许您编辑用户属性

![Screenshot](static/NsWzbi7jFoc7gdx0XRCcerCLnGd.png)
...
![Screenshot](static/Ob9ubEur5ov3XlxNnezcLURInWf.png)

1. 选择所需的用户角色，然后提交以保存更改

![Screenshot](static/Wp7ObEVu3o9PdmxuAQ1cyR8tnR2.png)
...
![Screenshot](static/DVL4biucioFlIBxmxb4cSUYtnqe.png)

1. 填写新用户的必要信息。必要时更改用户的角色，将其晋升为管理员用户

![Screenshot](static/AhuCbBfR2oyZ13xizsTctbnan9c.png)
...
![Screenshot](static/QPytbgFbOomzuexBFswc1w9znC6.png)

1. 点击 save，即可完成字段添加。

![Screenshot](static/SYaubQdHboYMRTxJErLc82BvnAd.png)
...
![Screenshot](static/K6GtbXVUYo7Ihxx2BhlcSqQQnRg.png)

1. 选择合适的 Theme，然后点击 Update 即可完成主题更换。

![Screenshot](static/ZkFnbeSoqok1cCxFXwLcylhRn5e.png)
...
![Screenshot](static/NdpYbBa8AowXrVxbBf7cVuGPnJf.png)
...
![Screenshot](static/RWGzbM3U1oBy8jxnFK9cSsGfn7t.png)
...
![Screenshot](static/UtCkbIOowomRBIxBoNzc5Jvxnfb.png)

![Screenshot](static/QbmkbawYXoTvqfx5H7bc5Vi3ncf.png)

#### 白名单电子邮件

CTFd 支持电子邮件域白名单。只有管理员才能从账户电子邮件白名单中添加或删除域。

![Screenshot](static/TrJLbWnl9oH9y7xiWolcyPUcndb.png)
...
![Screenshot](static/GqLKblD5jouPAkxIReScX0IGndc.png)
...
![Screenshot](static/QmV9bX7mrocUbZx98wcccs2Anic.png)
...
![Screenshot](static/GNyBbkPZKoKHALxgKmgcVCHEngJ.png)

1. 将 index 界面修改过后，我们点击 save，主页即可刷新。

![Screenshot](static/ZfDtbNBPsoQR9exSlwLcijmRnCh.png)

#### 删除界面

点击红色删除图标，即可删除界面。

![Screenshot](static/Rgv3b74LRoC4GvxSNe1czdnDn5b.png)

#### 新增界面

1. 点击界面中间的 pages 添加。

![Screenshot](static/Af6ib8ATuox8MIxkSDUcK3OXnih.png)

1. 输入新页面的路由，信息，是否可见，是否需要鉴权等信息，点击 save 即可保存一个新的界面

![Screenshot](static/DS1wbGtc2oD0hIx8xwscjxDMnQc.png)

### 4.2.4 道馆管理

点击 道馆，即可管理当前的所有道馆。

![Screenshot](static/RIlsbU8P8od90qxW8Mpc8wwqn0e.png)

点击具体的道馆，将跳转到道馆页面进行管理。

![Screenshot](static/Jsusbjg6ZoS7sKxJP0acZ0bWndc.png)

### 4.2.5 道馆全局可见

新添加的道馆默认均为个人可见，只有平台管理员才能权限在道馆管理界面中点击 Make This Dojo Official，使所有人可见。其他人是看不到该按钮。

![Screenshot](static/KhRsb1i9VomzPDxEH7zcbrkan1d.png)
